...
int main()
{
    ...
    // pingouin.marcher();
    // pingouin.glisser();
    shared_ptr<Pingouin> pingouin1 = make_shared<Pingouin>(10.0, 10.0, 15.0);
    shared_ptr<Pingouin> pingouin2 = make_shared<Pingouin>(10.0, 10.0, 15.0);
    shared_ptr<Pingouin> pingouin3 = make_shared<Pingouin>(10.0, 10.0, 15.0);
